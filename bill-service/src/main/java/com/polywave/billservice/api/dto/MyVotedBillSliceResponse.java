...
@Schema(description = "참여한 투표 안건 목록 페이지 응답")
public record MyVotedBillSliceResponse(
        @Schema(description = "참여한 투표 안건 목록", requiredMode = Schema.RequiredMode.REQUIRED)
        List<MyVotedBillResponse> content,
