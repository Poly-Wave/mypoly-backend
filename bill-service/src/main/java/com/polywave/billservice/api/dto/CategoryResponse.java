...
@Schema(description = "의안 카테고리 응답", requiredProperties = { "id", "code", "name" })
public record CategoryResponse(
        @Schema(description = "카테고리 ID", example = "1") Long id,

        @Schema(description = "카테고리 코드(고유)", example = "DIGITAL") String code,

        @Schema(description = "카테고리 표시명", example = "디지털") String name) {
