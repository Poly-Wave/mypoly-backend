...
@Schema(description = "보관함 안건 목록 페이지 응답")
public record BookmarkedBillSliceResponse(
        @Schema(description = "보관함 안건 목록", requiredMode = Schema.RequiredMode.REQUIRED)
        List<BookmarkedBillResponse> content,
