...
public record AgendaTabResponse(
        @Schema(description = "탭 코드", example = "HOT_DEBATE", requiredMode = Schema.RequiredMode.REQUIRED)
        String code,

        @Schema(description = "탭 라벨", example = "쟁쟁한", requiredMode = Schema.RequiredMode.REQUIRED)
        String label,
