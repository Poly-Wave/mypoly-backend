...
@Schema(description = "관심 주제 안건 목록 페이지 응답")
public record InterestAgendaSliceResponse(
        @Schema(description = "관심 주제 안건 목록", requiredMode = Schema.RequiredMode.REQUIRED)
        List<InterestAgendaResponse> content,
