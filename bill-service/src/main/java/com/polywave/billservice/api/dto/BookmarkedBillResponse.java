...
public record BookmarkedBillResponse(
        ...
        @Schema(description = "보관한 시각(KST, +09:00 오프셋 포함)", example = "2026-04-18T15:20:40.245724+09:00", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        @Schema(description = "현재 사용자의 보관 여부", example = "true", requiredMode = Schema.RequiredMode.REQUIRED)
        boolean bookmarked
) {
